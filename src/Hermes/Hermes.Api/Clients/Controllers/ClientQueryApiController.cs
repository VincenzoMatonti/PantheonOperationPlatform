    ...
    ClientQueryRequestMapper requestMapper) : ControllerBase
{
    ...
    [HttpGet("all")]
    public async Task<ActionResult<List<ClientResponse>>> GetAllClients(CancellationToken cancellationToken)
    {
    ...
    [HttpPost("byId")]
    public async Task<ActionResult<ClientResponse>> GetClientById(GetClientByIdRequest request, CancellationToken cancellationToken)
    {
    ...
    [HttpPost("byCode")]
    public async Task<ActionResult<ClientResponse>> GetClientByCode(GetClientByCodeRequest request, CancellationToken cancellationToken)
    {
        var query = _requestMapper.ToQuery(request);
    ...
    [HttpPost("codeById")]
    public async Task<ActionResult<ClientCodeResponse>> GetClientCodeById(GetClientCodeByIdRequest request, CancellationToken cancellationToken)
    {
        var query = _requestMapper.ToQuery(request);
    ...
    [HttpGet("allCodes")]
    public async Task<ActionResult<List<ClientCodeResponse>>> GetAllClientCodes(CancellationToken cancellationToken)
    {
    ...
    [HttpGet("active")]
    public async Task<ActionResult<List<ClientResponse>>> GetActiveClients(CancellationToken cancellationToken)
    {
    ...
    [HttpGet("nonActive")]
    public async Task<ActionResult<List<ClientResponse>>> GetNonActiveClients(CancellationToken cancellationToken)
    {
    ...
    [HttpGet("deleted")]
    public async Task<ActionResult<List<ClientResponse>>> GetDeletedClients(CancellationToken cancellationToken)
    {
